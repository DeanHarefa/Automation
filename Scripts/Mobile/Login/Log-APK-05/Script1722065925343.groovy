...
Mobile.setText(findTestObject('Object Repository/Mobile/Login/Input Email'), 'user.clients007@gmail.com', 0)
...
String actualText = Mobile.getText(findTestObject('Object Repository/Mobile/Login/verify email not verified'), 5)

//kondisi benar saat run time
assert actualText == "Not Verified"
