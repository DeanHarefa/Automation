...
//WebUI.verifyElementPresent(findTestObject('Mobile/Profile/Image Profile'), 5)
//
//WebUI.verifyElementPresent(findTestObject('Mobile/Profile/Fullname Profile'), 5)
//
//WebUI.verifyElementPresent(findTestObject('Mobile/Profile/Information Email'), 5)
//
//WebUI.verifyElementPresent(findTestObject('Mobile/Profile/Information Phone'), 5)
//
//WebUI.verifyElementPresent(findTestObject('Mobile/Profile/Information Birthdate'), 5)
