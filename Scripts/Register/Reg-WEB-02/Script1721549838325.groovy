...
WebUI.setText(findTestObject('RegisterPage/input_Email'), fakerData.internet.emailAddress())
...
WebUI.verifyElementPresent(findTestObject('RegisterPage/Verifikasi Email/Title_Verifikasi Email'), 0)

WebUI.verifyElementPresent(findTestObject('RegisterPage/Verifikasi Email/Subtitle_Verifikasi alamat email Anda'), 0)

WebUI.verifyElementPresent(findTestObject('RegisterPage/Verifikasi Email/content_Verifikasi Email dengan button kirim ulang'), 
    0)
