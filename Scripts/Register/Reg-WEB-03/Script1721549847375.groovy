...
WebUI.setText(findTestObject('RegisterPage/input_Konfirmasi kata sandi'), 'admin123@')

WebUI.click(findTestObject('RegisterPage/checkbox_Konfirmasi'))

WebUI.click(findTestObject('RegisterPage/button_Daftar'))

WebUI.verifyElementPresent(findTestObject('RegisterPage/Verifikasi Email/alert_kata sandi tidak sama'), 0)
