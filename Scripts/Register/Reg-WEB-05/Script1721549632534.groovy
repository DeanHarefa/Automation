...
WebUI.setText(findTestObject('RegisterPage/input_Kata Sandi'), '12345ab')

WebUI.setText(findTestObject('RegisterPage/input_Konfirmasi kata sandi'), '12345ab')

WebUI.click(findTestObject('RegisterPage/checkbox_Konfirmasi'))

WebUI.click(findTestObject('RegisterPage/button_Daftar'))

WebUI.verifyElementPresent(findTestObject('RegisterPage/Verifikasi Email/alert_kata sandi kurang dari 8 karakter'), 0)
