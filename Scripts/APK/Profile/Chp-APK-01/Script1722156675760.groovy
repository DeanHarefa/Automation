...
Mobile.verifyElementVisible(findTestObject('Mobile/Profile/information username'), 0)

Mobile.verifyElementVisible(findTestObject('Mobile/Profile/information email'), 0)

Mobile.verifyElementVisible(findTestObject('Mobile/Profile/information phone'), 0)

Mobile.verifyElementVisible(findTestObject('Mobile/Profile/information birthdate'), 0)
