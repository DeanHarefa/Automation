...
WebUI.verifyElementPresent(findTestObject('Web/RegisterPage/Verifikasi Email/Title_Verifikasi Email'), 0)

WebUI.verifyElementPresent(findTestObject('Web/RegisterPage/Verifikasi Email/Subtitle_Verifikasi alamat email Anda'), 0)

WebUI.verifyElementPresent(findTestObject('Web/RegisterPage/Verifikasi Email/content_Verifikasi Email dengan button kirim ulang'), 
    0)
