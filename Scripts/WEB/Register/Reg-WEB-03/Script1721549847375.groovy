...
WebUI.setText(findTestObject('Web/RegisterPage/input_Konfirmasi kata sandi'), 'admin123@')

WebUI.click(findTestObject('Web/RegisterPage/checkbox_Konfirmasi'))

WebUI.click(findTestObject('Web/RegisterPage/button_Daftar'))

WebUI.verifyElementPresent(findTestObject('Web/RegisterPage/Verifikasi Email/alert_kata sandi tidak sama'), 0)
