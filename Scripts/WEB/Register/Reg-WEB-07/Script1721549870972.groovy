...
WebUI.setText(findTestObject('Web/RegisterPage/input_Email'), GlobalVariable.email)
...
WebUI.verifyElementPresent(findTestObject('Web/RegisterPage/Verifikasi Email/alert_email sudah terdaftar'), 0)
